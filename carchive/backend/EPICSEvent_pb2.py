...
_VECTORSHORT.fields_by_name['val']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
_VECTORINT.fields_by_name['val'].has_options = True
_VECTORINT.fields_by_name['val']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
_VECTORENUM.fields_by_name['val'].has_options = True
_VECTORENUM.fields_by_name['val']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
_VECTORFLOAT.fields_by_name['val'].has_options = True
_VECTORFLOAT.fields_by_name['val']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
_VECTORDOUBLE.fields_by_name['val'].has_options = True
_VECTORDOUBLE.fields_by_name['val']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
